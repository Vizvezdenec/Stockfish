...
public:
  ...
  MovePicker(const Position&, Move, Value, const CapturePieceToHistory*, const CaptureMatHistory*);
  MovePicker(const Position&, Move, Depth, const ButterflyHistory*,
                                           const CapturePieceToHistory*,
                                           const CaptureMatHistory*,
...
private:
  ...
  const CaptureMatHistory* captureMatHistory;

...
class MovePicker {
   ...
   public:
    ...
    MovePicker(const Position&,
               ...
               const PawnHistory*,
               const PawnCaptureHistory*,
               int);
    MovePicker(const Position&, Move, int, const CapturePieceToHistory*, const PawnCaptureHistory*);
    Move next_move();
   ...
   private:
    ...
    const PawnCaptureHistory*    pawnCaptureHistory;
    Move                         ttMove;

...
constexpr int LOW_PLY_CAPTURE_HISTORY_SIZE = 5;
...
using LowPlyCaptureHistory = Stats<std::int16_t, 10692, LOW_PLY_CAPTURE_HISTORY_SIZE, PIECE_TYPE_NB, SQUARE_NB, PIECE_TYPE_NB>;

...
constexpr int LOW_PLY_CONT_HISTORY_SIZE = 5;
...
using ContPlyHistory = Stats<std::int16_t, 15000, LOW_PLY_CONT_HISTORY_SIZE - 1, SQUARE_NB, PIECE_TYPE_NB, SQUARE_NB, PIECE_TYPE_NB>;

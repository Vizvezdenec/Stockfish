...
namespace {
  ...
  constexpr int KingAttackWeights[PIECE_TYPE_NB] = { 0, 0, 77, 44, 44, 10 };
  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (b & kingRing[Them])
        {
            ...
            kingAttackersWeight[Us] += (Pt == BISHOP) * pos.opposite_bishops() * KingAttackWeights[Pt] / 2 + KingAttackWeights[Pt];

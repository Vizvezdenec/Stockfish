...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    pawnAttacksCount[Them] = popcount(kingRing[Us] & pe->pawn_attacks(Them));

    kingAttackersCount[Them] = pawnAttacksCount[Them];

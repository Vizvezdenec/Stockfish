...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score MobilityBonus[][32] = {
    { S(-59,-81), S(-53,-57), S( -9,-25), S(-2,-14), S( 10,10), S( 14, 17), // Knights
      S( 25, 21), S( 26, 27), S( 34, 29) },
    { S(-47,-61), S(-22,-24), S( 19, 0), S( 27, 11), S( 38, 28), S( 51, 42), // Bishops
      S( 58, 56), S( 62, 57), S( 61, 64), S( 71, 77), S( 77, 77), S( 80, 81),
      S( 90, 88), S( 98, 93) },
    { S(-55,-74), S(-28,-20), S(-10, 24), S( -8, 60), S( -5, 70), S(  1, 83), // Rooks
      S(  9,112), S( 18,113), S( 31,133), S( 27,144), S( 31,150), S( 37,164),
      S( 50,167), S( 47,171), S( 57,173) },
    { S(-38,-36), S(-28,-10), S( 1,  6), S( 1, 21), S( 17, 36), S( 17, 51), // Queens
      S( 32, 62), S( 41, 74), S( 39, 79), S( 45, 90), S( 69, 92), S( 60,104),
      S( 59,113), S( 66,119), S( 74,120), S( 74,124), S( 66,130), S( 73,140),

...
#undef S
  ...
  Score Evaluation<T>::king() const {
    ...
    int kingDangerBonus =  kingAttackersCount[Them] * kingAttackersWeight[Them]
     ...
     kingDanger += - 873 * !pos.count<QUEEN>(Them)
    ...
    if (kingDangerBonus < 200)
    	kingDangerBonus -= (200 - kingDangerBonus);

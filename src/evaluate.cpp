...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      bool  largePsq = psq * 16 > (NNUEThreshold1 + pos.non_pawn_material() / 64 + pos.count<PAWN>() * 16) * r50;
      ...
      if (    largePsq
          ...
          && (   abs(v) * 16 < NNUEThreshold2 * r50
              || (   pos.opposite_bishops()
                  && abs(v) * 16 < (NNUEThreshold1 + pos.non_pawn_material() / 64 + pos.count<PAWN>() * 16) * r50)))
          v = adjusted_NNUE();
  }

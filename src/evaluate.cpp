...
namespace {
  ...
  constexpr Value NNUEThreshold3 =   Value(1250);
...
Value Eval::evaluate(const Position& pos, Value previousStaticEval) {

  bool classical = !Eval::useNNUE
                ||  abs(eg_value(pos.psq_score())) * 16 > NNUEThreshold1 * (16 + pos.rule50_count())
                || (abs(previousStaticEval) > NNUEThreshold3 && abs(previousStaticEval) < VALUE_KNOWN_WIN);

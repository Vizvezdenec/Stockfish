...
Value to_corrected_static_eval(Value v, const Worker& w, const Position& pos, bool priorCapture, Stack* ss) {
...
void Search::Worker::clear() {
    ...
    fromToCorrectionHistory.fill(0);
...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    else if (ss->ttHit)
    {
        ...
        ss->staticEval = eval = to_corrected_static_eval(unadjustedStaticEval, *thisThread, pos, priorCapture, ss);
    ...
    else
    {
        if (ss->ttHit)
        {
            ...
            ss->staticEval = bestValue =
              to_corrected_static_eval(unadjustedStaticEval, *thisThread, pos, pos.captured_piece(), ss);

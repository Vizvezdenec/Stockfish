...
moves_loop: // When in check, search starts here
    ...
    Move countermove = thisThread->counterMoves1[pos.piece_on(prevSq)][from_to((ss-1)->currentMove)];
    if (!countermove || !(pos.pseudo_legal(countermove) && pos.legal(countermove)))

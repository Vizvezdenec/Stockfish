      ...
      if constexpr (Type == CAPTURES)
          ...
          m.value =      (*mainHistory)[pos.side_to_move()][from_to(m)]
                   ...
                   +     (threatened & from_sq(m) ?
                          ...
                          :                                                                           0)
                          :                                                                           0)
                   +     (  type_of(pos.moved_piece(m)) == KNIGHT && (knightCheckSq & to_sq(m)) ? 40000
                          : type_of(pos.moved_piece(m)) == BISHOP && (bishopCheckSq & to_sq(m)) ? 30000
                          : type_of(pos.moved_piece(m)) == QUEEN  && (queenCheckSq & to_sq(m))  ? 40000
                          : type_of(pos.moved_piece(m)) == ROOK   && (rookCheckSq & to_sq(m))   ? 50000
                          :                                                                           0);

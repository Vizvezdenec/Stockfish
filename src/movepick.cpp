      ...
      if constexpr (Type == CAPTURES)
          ...
          m.value =      (*mainHistory)[pos.side_to_move()][from_to(m)]
                   ...
                   +     (threatened & from_sq(m) ?
                          ...
                          :                                                                           0)
                          :                                                                           0)
                   +     (  type_of(pos.moved_piece(m)) == KNIGHT && (knightCheckSq & to_sq(m)) ? 10000
                          : type_of(pos.moved_piece(m)) == BISHOP && (bishopCheckSq & to_sq(m)) ? 7500
                          : type_of(pos.moved_piece(m)) == QUEEN  && (queenCheckSq & to_sq(m))  ? 10000
                          : type_of(pos.moved_piece(m)) == ROOK   && (rookCheckSq & to_sq(m))   ? 15000
                          :                                                                           0);

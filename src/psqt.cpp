...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-162,-109), S(-105,-80), S(-75,-50), S(-77,-20) },
   { S( -69, -75), S(-46,-61), S(-19,-9), S( -10,  1) },
   { S( -64, -40), S(-22,-30), S(  5, -14), S( 14, 28) },
   { S( -39, -41), S( 22, -26), S( 32, 1), S( 45, 42) },
   { S( -25, -42), S( 16,-23), S( 40,  9), S( 53, 38) },
   { S( -16, -51), S( 31,-44), S( 58,-9), S( 67, 17) },
   { S( -68, -71), S(-19,-45), S(  3,-31), S( 17, 15) },
   { S(-203, -106), S(-72,-97), S(-44,-49), S(-30,-25) }
  },
  { // Bishop

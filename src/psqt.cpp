...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { },
  { // Knight
   { S(-167,-105), S(-105,-58), S(-59,-55), S(-58,-18) },
   { S( -79, -67), S(-27,-53), S(-22,-13), S( -21, -3) },
   { S( -52, -41), S(-11,-42), S(  6, -10), S( 24, 30) },
   { S( -35, -41), S( 10, -5), S( 32, 15), S( 42, 33) },
   { S( -26, -62), S( 8, -18), S( 54,  7), S( 61, 42) },
   { S(  -2, -48), S( 40,-38), S( 62,  7), S( 49, 21) },
   { S( -84, -76), S(-33,-43), S( 24,-32), S( 37, 34) },
   { S(-194, -110), S(-80,-92), S(-76,-67), S(-41,-39) }
  },
  { // Bishop

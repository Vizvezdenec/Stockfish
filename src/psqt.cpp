...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-39,-68), S( -1,-29), S(-12,-33), S(-22, 3) },
   { S(-12,-42), S(  5,-17), S( 13,-14), S(  5, -4) },
   { S( -7,-13), S( 26,  0), S( -3, -11), S( 18, 10) },
   { S( -2,-26), S(  7, -3), S( 34, 7), S( 34, 16) },
   { S( -6,-22), S( 33, -8), S( 33,-13), S( 26, 20) },
   { S(-17,-28), S( -6,  6), S( 4,  2), S( 10, 10) },
   { S(-23,-34), S(-25,-26), S( 13, -2), S( -1, 12) },
   { S(-49,-47), S( 1,-48), S(-7,-42), S(-21,-23) }
  },
  { // Rook
   { S(-24, -4), S(-11,-15), S( -6, -6), S( 4,-4) },
   { S(-18,-13), S(-15,-9), S( -9, 7), S( 17, 1) },
   { S(-23, 14), S( -4,-1), S( 5,  1), S(-2,-7) },
   { S(-5, -10), S( -3, 0), S( -4, -14), S(-8, 15) },
   { S(-27, -9), S(-12, 5), S( -1, 13), S( 8,-11) },
   { S(-25,  3), S( 2,-6), S(  7,-19), S(2, 11) },
   { S( -5,  1), S(  4, -3), S( 11, 23), S(12,-15) },
   { S(-19, 18), S(-30,-16), S( -1, 20), S( 6, 12) }
  },
  { // Queen

...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { },
  { // Knight
   { S(-168,-105), S(-99,-68), S(-73,-49), S(-71,-18) },
   { S( -79, -69), S(-35,-55), S(-23,-14), S(-13,  3) },
   { S( -60, -39), S(-17,-36), S(  5, -7), S( 21, 28) },
   { S( -31, -38), S(  7,  5), S( 38, 14), S( 45, 35) },
   { S( -28, -48), S( 11,-19), S( 46,  5), S( 55, 37) },
   { S(  -8, -50), S( 32,-38), S( 64, -9), S( 53, 20) },
   { S( -73, -68), S(-25,-44), S( 12,-35), S( 37, 22) },
   { S(-198,-102), S(-80,-90), S(-61,-58), S(-35,-25) }
  },
  { // Bishop

...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-184,-104), S( -97,-58), S(-81,-47), S(-92,-26) },
   { S( -72, -72), S( -30,-61), S(-29,-12), S( -6,  0) },
   { S( -51, -15), S( -15,-22), S( 11,  0), S( 39, 25) },
   { S( -35, -26), S( -20, 13), S( 38, 26), S( 47, 26) },
   { S( -34, -30), S(   8, -9), S( 51,  7), S( 57, 26) },
   { S( -15, -46), S(   9,-39), S( 77,-37), S( 36,  4) },
   { S( -76, -61), S( -26,-35), S(  7,-64), S( 82, 22) },
   { S(-211, -76), S(-106,-88), S(-75,-60), S(-39,-22) }
  },
  { // Bishop

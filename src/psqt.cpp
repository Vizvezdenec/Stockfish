...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-41,-66), S( -2,-29), S(-12,-34), S(-25, -1) },
   { S(-10,-40), S(  6,-15), S( 13,-14), S(  4, 0) },
   { S( -7,-15), S( 25,  0), S( -3, -9), S( 17, 11) },
   { S( -1,-26), S(  7, -3), S( 30, 4), S( 35, 16) },
   { S( -6,-23), S( 32, -7), S( 30,-12), S( 27, 19) },
   { S(-17,-27), S( -1,  4), S( 2,  2), S( 9, 13) },
   { S(-22,-34), S(-22,-22), S( 12, -4), S( -3, 11) },
   { S(-49,-49), S(-1,-44), S(-9,-41), S(-23,-22) }
  },
  { // Rook
   { S(-24, -3), S(-12,-11), S( -6, -5), S( 3,-3) },
   { S(-18,-12), S(-13,-8), S( -7, 4), S( 13, 1) },
   { S(-22, 12), S( -5,-2), S( 4,  1), S(-2,-5) },
   { S(-9, -8), S( -4, 1), S( -4, -11), S(-7, 12) },
   { S(-26, -9), S(-12, 5), S( -1, 9), S( 7,-10) },
   { S(-25,  3), S( -1,-4), S(  6,-15), S(6, 9) },
   { S( -6,  1), S(  5, -1), S( 11, 20), S(12,-12) },
   { S(-20, 15), S(-27,-11), S( -3, 17), S( 5, 10) }
  },
  { // Queen

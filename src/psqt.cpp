...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  2,-10), S( -1,-5), S( 10, 9), S( 16, 0), S( 18, 11), S( 18,  7), S(  7,-3), S( -4,-19) },
   { S(-10, -8), S(-13,-8), S( 13,-6), S( 18, 2), S( 29,  2), S( 25,  3), S(  5,-4), S(-23, -4) },
   { S( -8,  5), S(-21,-3), S(  7,-6), S( 21,-4), S( 37,-10), S( 21,-12), S(  0,-7), S(-14, -8) },
   { S( 10, 13), S( -1, 3), S(-12, 3), S( 1,-11), S( 11,-12), S(  2, -7), S(-13,12), S(  3,  8) },
   { S( -5, 27), S(-10,19), S( -1,20), S( 17,28), S(-11, 30), S( -3,  7), S(-14, 5), S(-16, 13) },
   { S( -8,  0), S(  7,-9), S( -4,15), S(-12,21), S(  2, 24), S(-15, 18), S( 11, 3), S( -5,  8) }
  };

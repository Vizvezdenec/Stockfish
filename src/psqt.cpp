...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-165,-107), S(-101,-77), S(-77,-48), S(-78,-19) },
   { S( -74, -73), S(-42,-58), S(-21,-12), S( -10,  3) },
   { S( -64, -39), S(-21,-31), S(  5, -10), S( 16, 28) },
   { S( -34, -39), S( 14,-13), S( 36, 7), S( 46, 38) },
   { S( -27, -42), S( 15,-22), S( 41,  7), S( 53, 37) },
   { S( -14, -51), S( 30,-41), S( 60,-13), S( 61, 18) },
   { S( -68, -68), S(-20,-45), S(  4,-34), S( 27, 15) },
   { S(-202, -102), S(-76,-93), S(-48,-51), S(-31,-21) }
  },
  { // Bishop
